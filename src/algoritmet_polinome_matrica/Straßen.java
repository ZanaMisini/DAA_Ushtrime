...
public class Straßen {
    public static void main(String[] zanamaemira){
        ...
        Strassen.printMat(matrix_A,4,4);
        ...
        Strassen.printMat(matrix_B,4,4);

        int[][] result_matrix = Strassen.multiply_matrix(matrix_A, matrix_B);

        System.out.println("Result Array =>");
        Strassen.printMat(result_matrix,4,4);
    }
}
